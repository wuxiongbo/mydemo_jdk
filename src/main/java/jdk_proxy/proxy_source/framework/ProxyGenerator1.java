 ...
 */
final class ProxyGenerator1 extends ClassWriter {
     ...
     */
    private ProxyGenerator1(ClassLoader loader, String className, List<Class<?>> interfaces,
                           int accessFlags) {
    ...
    static byte[] generateProxyClass(ClassLoader loader,
                                     ...
                                     int accessFlags) {
        ProxyGenerator1 gen = new ProxyGenerator1(loader, name, interfaces, accessFlags);
    ...
    private void generateLookupAccessor() {
        ...
        mv.visitLdcInsn(Type.getType(Proxy1.class));
    ...
    private static class ProxyMethod {
        ...
        private ProxyMethod(Method method, String methodFieldName) {
            this(method, toShortSignature(method),
    ...
    static String toShortSignature(Method method) {
    ...
    static String toShortString(Method method) {
        return "method " + method.getDeclaringClass().getTypeName() +
